import{_ as i,H as a,k as n,am as l,a1 as p,G as h}from"./chunks/framework.CIXq18Py.js";const F=JSON.parse('{"title":"小程序生命周期","description":"微信小程序生命周期的全解","frontmatter":{"title":"小程序生命周期","description":"微信小程序生命周期的全解"},"headers":[],"relativePath":"web/weChat/lifeCycle.md","filePath":"web/weChat/lifeCycle.md"}'),k={name:"web/weChat/lifeCycle.md"},t=l(`<h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">一、页面生命周期</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">代码执行顺序</span></span>
