import{_ as s,H as i,G as a,al as n}from"./chunks/framework.Dt0boiFn.js";const y=JSON.parse('{"title":"小程序生命周期","description":"微信小程序生命周期的全解","frontmatter":{"title":"小程序生命周期","description":"微信小程序生命周期的全解"},"headers":[],"relativePath":"web/weChat/lifeCycle.md","filePath":"web/weChat/lifeCycle.md","lastUpdated":1719018861000}'),l={name:"web/weChat/lifeCycle.md"},p=n(`<h1 id="小程序生命周期" tabindex="-1">小程序生命周期 <a class="header-anchor" href="#小程序生命周期" aria-label="Permalink to &quot;小程序生命周期&quot;">​</a></h1><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">一、页面生命周期</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">代码执行顺序</span></span>
