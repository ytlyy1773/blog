...
export default defineConfig({
  title: "一条懒羊羊",
  description: "一条懒羊羊的博客，专注于前端开发技术分享，涵盖Vue、Wechat、Node.js、Harmony等框架教程。提供详实的开发工具推荐、Vitepress博客搭建指南、Linux实用技巧和SEO优化策略，帮助开发者提升技能，快速解决开发难题。",
  lang: "zh-CN",
  head: [
    [
      "meta",
    ...
    ["meta", { name: "og:description", content: "一条懒羊羊的博客，记录vue， wechat， nodejs， harmony等前端知识。开发推荐使用软件， vitepress博客搭建教程，linux使用教程， 如何深度优化网站seo" }],
    [
      "meta",
      {
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: "github", link: "https://github.com/ytlyy1773/blog.git" },
      {
        icon: {
    ...
    footer: {
      message: `<img src="https://beian.mps.gov.cn/web/assets/logo01.6189a29f.png" alt='网站备案信息'  style="width: 16px;margin-right: 10px;"> <a style='cursor: pointer;' href="https://beian.mps.gov.cn/#/query/webSearch?code=41132402411828"  rel="noreferrer" target="_blank">豫公网安备41132402411828</a>`,
