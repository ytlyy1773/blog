...
interface FunctionDeclaration extends BaseNode {
    ...
    id?: Identifier | null;
    params: Array<Identifier | Pattern$2 | RestElement>;
    body: BlockStatement$1;
    generator: boolean;
    async: boolean;
...
interface ClassMethod extends BaseNode {
    ...
    params: Array<Identifier | Pattern$2 | RestElement | TSParameterProperty>;
    body: BlockStatement$1;
    computed: boolean;
    static: boolean;
    generator: boolean;
...
type Pattern$2 = AssignmentPattern | ArrayPattern | ObjectPattern;
...
declare class Trouter<T = Function> {
	...
	add(method: Methods, pattern: Pattern$1, ...handlers: T[]): this;
	use(pattern: Pattern$1, ...handlers: T[]): this;
	all(pattern: Pattern$1, ...handlers: T[]): this;
	get(pattern: Pattern$1, ...handlers: T[]): this;
	head(pattern: Pattern$1, ...handlers: T[]): this;
	patch(pattern: Pattern$1, ...handlers: T[]): this;
	options(pattern: Pattern$1, ...handlers: T[]): this;
	connect(pattern: Pattern$1, ...handlers: T[]): this;
	delete(pattern: Pattern$1, ...handlers: T[]): this;
	trace(pattern: Pattern$1, ...handlers: T[]): this;
	post(pattern: Pattern$1, ...handlers: T[]): this;
	put(pattern: Pattern$1, ...handlers: T[]): this;
}
