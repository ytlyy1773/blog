    ...
    [`${componentCls}-wrapper`]: {
      ...
      [`${listCls}${listCls}-picture, ${listCls}${listCls}-picture-card`]: {
        [itemCls]: {
          ...
          [`${itemCls}-thumbnail`]: (0, _extends2.default)((0, _extends2.default)({}, _style.textEllipsis), {
...
const genPictureCardStyle = token => {
  ...
  return {
    [`${componentCls}-wrapper${componentCls}-picture-card-wrapper`]: (0, _extends2.default)((0, _extends2.default)({}, (0, _style.clearFix)()), {
