...
const initializedState = spec => {
  ...
  const slidesToLoad = getOnDemandLazySlides((0, _extends2.default)((0, _extends2.default)({}, spec), {
    currentSlide,
    lazyLoadedList
  }), spec);
...
const changeSlide = (spec, options) => {
  ...
  if (options.message === 'previous') {
    ...
    if (infinite) {
      const direction = siblingDirection((0, _extends2.default)((0, _extends2.default)({}, spec), {
        targetSlide
      }));
